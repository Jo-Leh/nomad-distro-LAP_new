![docker image](https://github.com/Jo-Leh/nomad-distro-LAP_new/actions/workflows/docker-publish.yml/badge.svg)


# Jo-Leh's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of Jo-Leh.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Jo-Leh/nomad-distro-LAP_new.git
    cd nomad-distro-LAP_new
    ```

    or

    ```sh
    curl-L -o nomad-distro-LAP_new.zip "https://github.com/Jo-Leh/nomad-distro-LAP_new/archive/main.zip"
    unzip nomad-distro-LAP_new.zip
    cd nomad-distro-LAP_new
    ```
...
your `docker-compose.yaml` with `ghcr.io/jo-leh/nomad-distro-lap_new:main` for the services
...
```sh
docker pull ghcr.io/jo-leh/nomad-distro-lap_new/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/Jo-Leh/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/Jo-Leh/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Jo-Leh/nomad-distro-LAP_new/manifests/main": unauthorized`
